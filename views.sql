...
COMMENT ON VIEW laud_aktiivne_mitteaktiivne IS 'Vaade leiab andmed aktiivsetest ja mitteaktiivsetest laudadest. Vaates n�idatakse ka laua asukohta, mis annab t��tajale �levaate sellest, kus aktiivsed ja mitteaktiivsed lauad asuvad.';
...
COMMENT ON VIEW laud_koik_seisundid IS 'Vaade leiab andmed mistahes seisundites olevatest laudadest. Vaates n�idatakse ka laua asukohta, mis annab t��tajale �levaate sellest, kus lauad asuvad.';
...
COMMENT ON VIEW laud_detailid IS 'Vaade leiab andmed k�ikide laudade ja nende detailide kohta. Detailides sisaldub registreerimise aeg, registreerija, registreerija e-mail, laua asukoht, kohtade arv, laua seisund, kommentaar, laua materjal ning laua kategooria(d).';
...
COMMENT ON VIEW laud_kategooria IS 'Vaade leiab andmed laudadest, mis kuuluvad m�nda kategooriasse. Vaates n�idatakse ka laua kategooria t��pi, mida kuvatakse laua kategooria veerus sulgudes.';
...
COMMENT ON VIEW laud_koondaruanne IS 'Vaade leiab koondtulemused k�ikide laudade seisunditest. Vaates n�idatakse ka laudade arvu, mis vastavasse seisundisse kuulub. Tulemus on sorteeritud laudade arvu j�rgi kahanevalt.';
